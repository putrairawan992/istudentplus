...
export const COLLECTIONS: CollectionMeta[] = [
  ...
  { key: "leads", label: "Consultation & Contact Leads", description: "Submissions from the Free Consultation and Contact forms", kind: "list", usedOn: "Home, Contact", icon: "📥", group: "Inbox" },
];
